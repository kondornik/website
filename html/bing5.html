      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <p> Search Engine that finds sense in a heap of Web pages</p>
			...
			<form action="bing.aspx" method="post" runat="server">
			
			<div style="text-align: left; ">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <B> Enter query: <asp:textbox id="tbQuery" runat="server" width="33%"  />
           </B>
           &nbsp;&nbsp;
				
           <asp:button id="btnSearch" text="Search" OnClick="SearchBtn_Click" runat="server"/>
						&nbsp;&nbsp;

           <button type="button" style="font-size: 14px; font-weight:bold" id="btnSum" 
title="Usually takes 5-7 seconds; under heavy load may take longer."
OnClick="SumBtn_Click()" />Get a text summary<br>of results!</button>
						&nbsp;&nbsp;
						
						<asp:textbox id="tbSentences" width="25" runat="server" /> sentences

			<asp:checkbox id="chkImages" Text="Show images" Checked="true" Enabled="true" Visible="false" runat="server" 
ToolTip="Increases the load time about 2 times."/>
						&nbsp;&nbsp;

						<button type=button OnClick="javascript:window.open('helpyahoo.htm', 'helpsense', 'width=450, height=600, status=yes, resizable=yes, scrollbars=yes'); return false;">Help</button>

						<asp:RequiredFieldValidator id="valRequired" runat="server" ControlToValidate="tbSentences"
							ErrorMessage="* You must enter a value into textbox" Display="dynamic">*
						</asp:RequiredFieldValidator>

						<asp:RangeValidator id="valRange" runat="server"
						ControlToValidate="tbSentences"
						MinimumValue="1"
						MaximumValue="250"
						Type="Integer"
						ErrorMessage="* Please enter the number of sentences greater than 0." Display="static">*
						</asp:RangeValidator>
						<p>
...
<p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button type="button" id="btnCheck" value="Uncheck all" OnClick="CheckBtn_Click()" />Uncheck all</button>
...
<div style=" width:95%; text-align:right; font-size:smaller">
				Powered by&nbsp;&nbsp;<a href="https://datamarket.azure.com/dataset/bing/search"><img src="http://go.microsoft.com/fwlink/?LinkId=89151" border="0"  style="align: left;"></a>
</div>
           <button type="button" style="font-size: 14px; font-weight:bold" id="btnSum2" 
title="Usually takes 5-7 seconds; under heavy load may take longer."
OnClick="SumBtn_Click()" >Get a text summary<br>of results!</button>
						&nbsp;&nbsp;
...
<center>
<p>
        <asp:hyperlink id="HyperLink0" NavigateURL="sense6.aspx" runat="server">
            Home
        </asp:hyperlink>
        &nbsp;&nbsp;&nbsp;
        <asp:hyperlink id="HyperLink1" NavigateURL="about.htm" runat="server">
            About
        </asp:hyperlink>
        &nbsp;&nbsp;&nbsp;
        <asp:hyperlink id="HyperLink4" NavigateURL="samples.htm" runat="server">
            Samples
        </asp:hyperlink>
        &nbsp;&nbsp;&nbsp;
        <asp:hyperlink id="HyperLink3" NavigateURL="contactus.aspx" runat="server">
            Contact us
        </asp:hyperlink>
        &nbsp;&nbsp;&nbsp;
<p>

Copyright &copy; 2007-2016 Semantic Engines LLC
</center>
